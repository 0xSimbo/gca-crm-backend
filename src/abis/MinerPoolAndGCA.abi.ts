export const minerPoolAndGCAAbi = [
  {
    inputs: [
      { internalType: "address[]", name: "_gcaAgents", type: "address[]" },
      { internalType: "address", name: "_glowToken", type: "address" },
      { internalType: "address", name: "_governance", type: "address" },
      { internalType: "bytes32", name: "_requirementsHash", type: "bytes32" },
      { internalType: "address", name: "_earlyLiquidity", type: "address" },
      { internalType: "address", name: "_usdcToken", type: "address" },
      { internalType: "address", name: "_vetoCouncil", type: "address" },
      { internalType: "address", name: "_holdingContract", type: "address" },
    ],
  ...
  { inputs: [], name: "UserAlreadyClaimed", type: "error" },
  {
    ...
    inputs: [
      ...
      { indexed: false, internalType: "address", name: "gca", type: "address" },
      {
        indexed: false,
        internalType: "uint256",
        name: "slashNonce",
  ...
  },
  {
    inputs: [],
    name: "GLOW_TOKEN",
    outputs: [{ internalType: "contract IGlow", name: "", type: "address" }],
    stateMutability: "view",
    type: "function",
  },
  {
  ...
  },
  {
    ...
    outputs: [
      { internalType: "contract IHoldingContract", name: "", type: "address" },
    ],
    stateMutability: "view",
    type: "function",
  },
  ...
  {
    inputs: [{ internalType: "uint256", name: "bucketId", type: "uint256" }],
    name: "bucket",
    outputs: [
      {
        components: [
          { internalType: "uint64", name: "originalNonce", type: "uint64" },
          { internalType: "uint64", name: "lastUpdatedNonce", type: "uint64" },
          {
          ...
          {
            components: [
              { internalType: "uint128", name: "totalNewGCC", type: "uint128" },
              {
                internalType: "uint64",
                name: "totalGLWRewardsWeight",
                type: "uint64",
  ...
  {
    inputs: [
      { internalType: "address[]", name: "gcasToSlash", type: "address[]" },
    ...
    outputs: [
      {
        components: [
          ...
          { internalType: "uint64", name: "maxClaimTimestamp", type: "uint64" },
          {
            internalType: "uint128",
            name: "totalSlashableBalance",
            type: "uint128",
  ...
  },
  {
    ...
    outputs: [
      {
        components: [
          { internalType: "uint48", name: "lastUpdatedBucket", type: "uint48" },
          { internalType: "uint48", name: "maxBucketId", type: "uint48" },
          {
            internalType: "uint48",
  ...
  },
  {
    ...
    outputs: [
      ...
      { internalType: "uint256", name: "slashableAmount", type: "uint256" },
      {
        internalType: "uint256",
  ...
  },
  {
    ...
    outputs: [
      {
        components: [
          { internalType: "bool", name: "inheritedFromLastWeek", type: "bool" },
          { internalType: "uint256", name: "amountInBucket", type: "uint256" },
          { internalType: "uint256", name: "amountToDeduct", type: "uint256" },
        ],
